...
export default function TeacherLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="chamada" options={{ title: 'Chamada', tabBarIcon: ({ focused }) => <Icon emoji="📋" focused={focused} /> }} />
      <Tabs.Screen name="notas" options={{ title: 'Notas', tabBarIcon: ({ focused }) => <Icon emoji="✏️" focused={focused} /> }} />
      <Tabs.Screen name="jornada" options={{ title: 'Jornada', tabBarIcon: ({ focused }) => <Icon emoji="🗓️" focused={focused} /> }} />
